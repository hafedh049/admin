...
class _EditOfferState extends State<EditOffer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: Text("Edit Offer".tr, style: GoogleFonts.poppins(color: dark, fontSize: 20)),
        leading: IconButton(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(
                              height: 40,
                              child: TextField(
                                controller: _offerNameController..text = widget.offer.offerName,
                          ...
                          return IgnorePointer(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                if (_offerNameController.text.trim().isEmpty) {
                                  ...
                                  try {
                                    ...
                                    if (_banner != null) {
                                      final TaskSnapshot task = await FirebaseStorage.instance.ref().child("/offers/${widget.offer.offerID}.png").putFile(_banner!);
                                      path = await task.ref.getDownloadURL();
                                    }

                                    await FirebaseFirestore.instance.collection("offers").doc(widget.offer.offerID).update(
                                          OfferModel(
                                    ...
                                    showToast(context, "Offer Modified Successfully".tr);
                              ...
                              child: Container(
                                ...
                                child: Text("Edit Offer".tr, style: GoogleFonts.abel(color: white, fontSize: 14, fontWeight: FontWeight.bold)),
                              ),
                            ),
                          );
                        },
